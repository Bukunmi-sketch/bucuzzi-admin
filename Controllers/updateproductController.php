 ...
 */
                   ...
                   if($imgInstance->imgextension($picture)){
                     if($imgInstance->largeImage($dpsize)){
                         if($imgInstance->moveImage($dptemp, $dirfile)){
                             if(  $productInstance->updateProducts($productid, $picture, $product_name, $description, $category, $price, $commission, $available) ){
    ...
    /*    }else{
        ...
        if(  $productInstance->updateWithoutPics($productid, $product_name, $description, $category, $price, $commission, $available) ){                            
            echo "success";
        }else{
