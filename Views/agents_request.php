<?php
  ...
  include './auth/redirect.php';
    ...
    $userInfo=$adminInstance->getuserinfo($sessionid);
   ...
   <?php include './components/header.php' ; ?>
    <main>
      ...
      <div class="follow-unfollow">          
         <button type="submit" class="justbtn" > Agent Requests </button>     
      </div>

      <?php 
          $getStmt= $agentInstance->getPendingAgents();
      ...
      ?>
                 ...
                 <div class="each-user" id="eachagent<?php echo  "{$itemdata['id']}" ; ?>">
                      ...
                      <div class="follow-unfollow">     
                           <form action="" class="agent-modify">
                              ...
                              <button data-agentidentity="<?php echo  "{$itemdata['id']}" ; ?>" id="eachdecline<?php echo  "{$itemdata['id']}" ; ?>" class="declinebtn" > Decline </button>               
       ...
       <h4 style="font-family:'poppins', sans-serif; text-align:center; margin-top:300px; font-weight:500;">
         <i class="fa fa-info-circle" aria-hidden="true"></i>
            No agent request at the moment
        </h4>
       <?php endif ?>
   </div> <!---- end of middle --->
